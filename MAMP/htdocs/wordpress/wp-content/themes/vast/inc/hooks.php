...
if ( ! function_exists( 'vast_banner_style' ) ) :
	...
	function vast_banner_style() {
		...
		if ( vast_theme_setting( 'navbar-font-color', true ) !== $navbar_font_color ) {
			$css[] = array(
				'element' => '.home .navbar-light .navbar-nav .nav-link, .home #navbar .icon-chevron-down::before, .home #header.sticky.sticky--top #quadmenu.detheme_default_menu .quadmenu-navbar-nav > li > a > .quadmenu-item-content',
				'rules'   => array(
		...
		if ( vast_theme_setting( 'primary-color', true ) !== $primary_color ) {
			...
			$css[] = array(
				'element' => '.uf-card-body .entry__content a',
				'rules'   => array(
			...
			$css[] = array(
				'element' => '.navbar-light .navbar-nav .current-menu-item, .current-menu-item > .nav-link, .menu-item:hover::before, .menu-item:hover > .nav-link',
				'rules' => array(
					'color' => esc_attr( $primary_color . '!important' ),
				),
			);
			...
			$css[] = array(
				'element' => '.navbar-light .navbar-nav .current-menu-ancestor, .current-menu-ancestor > .nav-link',
				'rules' => array(
					'color' => esc_attr( $primary_color . '!important' ),
				),
			);
			...
			$css[] = array(
				'element' => '.navbar-light .navbar-nav .current-menu-ancestor::after, .current-menu-parent::after, .current-menu-item::after',
				'rules' => array(
					'background' => esc_attr( $primary_color . '!important' ),
				),
			);
			...
			$css[] = array(
				'element' => '#header.sticky--not-top.sticky--unpinned .navbar-light .navbar-nav .menu-item:hover::before, .menu-item:hover > .nav-link',
				'rules' => array(
					'color' => esc_attr( $primary_color . '!important' ),
				),
			);
			...
			$css[] = array(
				'element' => '.navbar-light .navbar-nav .dropdown-menu .menu-item:hover > .nav-link',
				'rules' => array(
					'color' => esc_attr( $primary_color . '!important' ),
				),
			);
			...
			$css[] = array(
				'element' => '#header.sticky--not-top.sticky--unpinned .navbar-light .navbar-nav .dropdown-menu .menu-item:active > .nav-link, .menu-item:hover > .nav-link',
				'rules' => array(
					'color' => esc_attr( $primary_color . '!important' ),
				),
			);
			...
			$css[] = array(
				'element' => '#header.sticky.sticky--not-top .navbar-light .navbar-nav .current-menu-ancestor.menu-item::before, .current-menu-item.menu-item::before',
				'rules' => array(
					'color' => esc_attr( $primary_color . '!important' ),
				),
			);
