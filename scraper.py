...
# form_data = {'Email': 'myusername', 'pass': 'secretpassword'} 
...
data = soup.find("h3",class_="productname")
print(data)
# while True:
#     sleep(3)
#     try:
#         doc = html.fromstring(page.content)
#         XPATH_NAME = '//div[@id="container"]//text()'
# [prod.text.strip() for prod in  soup.select("div.")]
